(() => {
  ...
  async function extractMessages({ root }) {
    ...
    let monthValues = /* @__PURE__ */ new Map();
    let wordCounts = /* @__PURE__ */ new Map();
    let emojiCounts = /* @__PURE__ */ new Map();
      ...
      if (channelDir.isDirectory) {
        ...
        for await (const message of messages) {
          ...
          for (const customEmoji of getCustomEmojis(message.Contents)) {
            totalCustomEmojis++;
            if (!emojiCounts.has(customEmoji))
              emojiCounts.set(customEmoji, 0);
            emojiCounts.set(customEmoji, emojiCounts.get(customEmoji) + 1);
          }
          for (const defaultEmoji of getDefaultEmojis(message.Contents)) {
            totalDefaultEmojis++;
            if (!emojiCounts.has(defaultEmoji))
              emojiCounts.set(defaultEmoji, 0);
          ...
          if (!hourValues.has(hourKey))
            hourValues.set(hourKey, 0);
          hourValues.set(hourKey, hourValues.get(hourKey) + 1);
          const monthKey = date.format("YYYY-MM");
          if (!monthValues.has(monthKey))
            monthValues.set(monthKey, 0);
    ...
    for (const [hour, count] of hourValues.entries()) {
      hourLabels.push((0, import_dayjs3.default)().hour(hour).format("h A"));
      hourData.push(count);
    }
    let monthLabels = [];
    for (let currentDate = oldest.date.clone(); currentDate.isBefore(newestDate); currentDate = currentDate.add(1, "month"))
    ...
    return () => /* @__PURE__ */ __jsx(__fragment, null, /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Messages"), /* @__PURE__ */ __jsx("div", null, "You've sent ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMessages)), " total messages in your", " ", /* @__PURE__ */ __jsx("b", null, formatNum(totalDays)), " days here."), /* @__PURE__ */ __jsx("div", null, "That's an average of ", /* @__PURE__ */ __jsx("b", null, formatNum(averageMessages)), " messages a day."), /* @__PURE__ */ __jsx("div", null, "That's a total of ", /* @__PURE__ */ __jsx("b", null, formatNum(totalWords)), " words."), /* @__PURE__ */ __jsx("div", null, "That's a total of ", /* @__PURE__ */ __jsx("b", null, formatNum(totalCharacters)), " characters."), /* @__PURE__ */ __jsx("div", null, "Text wasn't enough? You sent ", /* @__PURE__ */ __jsx("b", null, formatNum(totalAttachments)), " files."), /* @__PURE__ */ __jsx("div", null, "Like emojis? You used ", /* @__PURE__ */ __jsx("b", null, formatNum(totalCustomEmojis)), " custom emojis and", " ", /* @__PURE__ */ __jsx("b", null, formatNum(totalDefaultEmojis)), " default emojis."), /* @__PURE__ */ __jsx("div", null, "Overall, you pinged ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMentions)), " users, roles, and channels"), /* @__PURE__ */ __jsx("div", null, "Your first message was ", /* @__PURE__ */ __jsx("b", null, oldest.message.Contents), " on", " ", /* @__PURE__ */ __jsx("b", null, oldest.date.format(SHORT_DATE_TIME)), " in ", /* @__PURE__ */ __jsx("b", null, oldest.channel))), /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topWords.length, " words"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topWords.map(([word, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", word), /* @__PURE__ */ __jsx("td", {
      className: "end"
    }, formatNum(count))))))), /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topEmojis.length, " emojis"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topEmojis.map(([emoji, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", /* @__PURE__ */ __jsx("img", {
      className: "emoji",
      src: getEmojiUrl(emoji)
    })), /* @__PURE__ */ __jsx("td", {
      className: "end"
    }, formatNum(count)))))))), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx(Chart2, {
      type: "bar",
    ...
    })), /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx(Chart2, {
      type: "bar",
  ...
  async function extractAccount({ root }) {
    ...
    for (const game of topGames)
      game.application_name = await fetch(`https://discord.com/api/v10/applications/${game.application_id}/rpc`).then((res) => res.json()).then((res) => res.name);
    return () => /* @__PURE__ */ __jsx(__fragment, null, /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Tile, {
      size: 2
    }, /* @__PURE__ */ __jsx("h1", null, /* @__PURE__ */ __jsx("img", {
      ...
      label: "created",
      value: getSnowflakeTimestamp(user.id).format(SHORT_DATE_TIME)
    }), /* @__PURE__ */ __jsx(Field, {
      label: "ip address",
      value: user.ip
    }), /* @__PURE__ */ __jsx(Field, {
      ...
      label: "money spent",
      value: moneySpent
    }))), /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Flags"), /* @__PURE__ */ __jsx("div", {
      className: "field-group"
    }, extractUserFlags(user.flags).map(({ flag, description }) => /* @__PURE__ */ __jsx(Field, {
      label: flag,
      value: description
    })))), /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Connections"), /* @__PURE__ */ __jsx("div", {
      className: "field-group"
    }, user.connections.map(({ type, name }) => /* @__PURE__ */ __jsx(Field, {
      label: type,
      value: name
    }))))), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx(Chart2, {
      type: "bar",
  ...
  drag.addEventListener("drop", async (e) => {
    ...
    document.body.appendChild(/* @__PURE__ */ __jsx("div", {
      className: "container"
    }, /* @__PURE__ */ __jsx(Account, null), /* @__PURE__ */ __jsx(Messages, null)));
    drag.remove();
  }, false);
})();
/*!
