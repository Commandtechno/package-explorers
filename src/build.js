(() => {
    ...
    "node_modules/twemoji-parser/dist/index.js"(exports) {
      ...
      function parse3(text, options) {
        ...
        var getTwemojiUrl = options && options.buildUrl ? options.buildUrl : function(codepoints2, assetType2) {
          return assetType2 === "png" ? "https://twemoji.maxcdn.com/v/latest/72x72/" + codepoints2 + ".png" : "https://twemoji.maxcdn.com/v/latest/svg/" + codepoints2 + ".svg";
        };
        var entities = [];
  ...
  // src/__jsx.tsx
  function __jsx2(tag, props, ...children) {
    const element = typeof tag === "string" ? document.createElement(tag) : props ? tag(props) : tag();
    if (props)
      Object.entries(props).forEach(([key, value]) => element[key] = value);
    element.append(...children.flat().filter((child) => child !== false));
    return element;
  }
  function __fragment2() {
    return document.createDocumentFragment();
  }
  Object.assign(window, { __jsx: __jsx2, __fragment: __fragment2 });
  ...
  // node_modules/gocsv/dist/gocsv.esm.js
  ...
  var ParseErrMessage;
  (function(ParseErrMessage2) {
    ParseErrMessage2["ErrTrailingComma"] = "extra delimiter at end of line";
    ParseErrMessage2["ErrBareQuote"] = 'bare " in non-quoted-field';
    ParseErrMessage2["ErrQuote"] = 'extraneous or missing " in quoted-field';
    ParseErrMessage2["ErrFieldCount"] = "wrong number of fields";
  })(ParseErrMessage || (ParseErrMessage = {}));
  var ParseError = class extends ReaderError {
    constructor(args) {
      if (args.err === ParseErrMessage.ErrFieldCount) {
        super(`record on line ${args.line}: ${args.err}`);
      } else if (args.startLine !== args.line) {
        super(`record on line ${args.startLine}; parse error on line ${args.line}, column ${args.column}: ${args.err}`);
      } else {
  ...
  var errInvalidDelim = new ReaderError("invalid field or comment delimiter");
  var validDelim = (s) => {
  ...
  var Reader = class {
    ...
    _validateCommaComment() {
      if (this.comma === this.comment || !validDelim(this.comma) || this.comment !== "" && !validDelim(this.comment)) {
    ...
    _readRecord() {
      ...
      if (this._readLineSkipEmpty())
        return [];
      if (!this.parsingQuotedString) {
        this.recordBuffer.reset();
        this.recLine = this.numLine;
      }
      if (this._fillRecordBuffer())
        return [];
  ...
  // src/util/fs.js
  async function readNextEntriesAsync(reader) {
    return await new Promise((resolve2, reject) => reader.readEntries(resolve2, reject));
  }
  ...
  async function detectSubfolder(dir) {
  ...
  var CustomFile = class {
    ...
    async file() {
      return new Promise((resolve2, reject) => this.entry.file(resolve2, reject));
    }
    async stream() {
    ...
    async *csv({ withHeaders }) {
      ...
      const headers = withHeaders && await new Promise((resolve2) => reader.readN(1, resolve2));
  ...
  var CustomDirectory = class {
    ...
    dir(name) {
      return new Promise((resolve2, reject) => this.entry.getDirectory(name, {}, (dir) => resolve2(new CustomDirectory(dir)), reject));
    }
    file(name) {
      return new Promise((resolve2, reject) => this.entry.getFile(name, {}, (entry) => resolve2(new CustomFile(entry)), reject));
    }
    async findDir(fn) {
      for await (const entry of this)
        if (entry.isDirectory && fn(entry))
          return entry;
    }
    async findFile(fn) {
      for await (const entry of this)
        if (entry.isFile && fn(entry.name))
          return entry;
    }
    async *[Symbol.asyncIterator]() {
      ...
      while (true) {
        ...
        for (const entry of entries)
          yield entry.isDirectory ? new CustomDirectory(entry) : entry.isFile ? new CustomFile(entry) : entry;
      }
    }
  };

  // src/services/discord/tiles/Messages.jsx
  ...
  var GRID_COLOR = "rgba(255,255,255,0.1)";
  ...
  function Chart2(props) {
    ...
    const canvas = /* @__PURE__ */ __jsx("canvas", null);
    new Chart(canvas, props);
    return canvas;
  }

  // src/components/Tile.jsx
  function Tile({ size } = { size: 1 }) {
    return /* @__PURE__ */ __jsx("div", {
      className: `tile tile-${size}`
    });
  }

  // src/services/discord/constants/COLORS.js
  var BLURPLE = "#5865F2";

  // src/constants/DATE_FORMATS.js
  var SHORT_DATE_TIME = `MMMM D, YYYY h:mm A`;
  var LONG_DATE_TIME = `dddd, ${SHORT_DATE_TIME}`;

  // src/services/discord/enums/ChannelTypes.js
  var ChannelTypes = {
    DM: 1,
    GROUP_DM: 3,
    GUILD_TEXT: 0,
  ...
  function formatCurrency(amount, currency) {
    return amount.toLocaleString(void 0, { style: "currency", currency });
  }
  ...
  // src/services/discord/helpers.js
  var import_twemoji_parser = __toESM(require_dist());
  var import_dayjs2 = __toESM(require_dayjs_min());
  var import_regex = __toESM(require_regex());

  // src/services/discord/constants/USER_FLAGS.js
  var USER_FLAGS = Object.entries({
    DISCORD_EMPLOYEE: {
  ...
  // src/services/discord/helpers.js
  var MENTION_REGEX = /\<(@|@!|#|@&)\d+\>/g;
  var GLOBAL_CUSTOM_EMOJI_REGEX = /<a?:\w+:\d+>/g;
  var CUSTOM_EMOJI_REGEX = /<a?:(?<name>\w+):(?<id>\d+)>/;
  function hasFlag(flags, bit) {
    return (BigInt(flags) & bit) === bit;
  }
  function extractUserFlags(flags) {
  ...
  function getCustomEmojis(text) {
    return text.match(GLOBAL_CUSTOM_EMOJI_REGEX) ?? [];
  }
  function getDefaultEmojis(text) {
    return text.match(import_regex.default) ?? [];
  }
  function getEmojiUrl(emoji) {
    const customEmoji = emoji.match(CUSTOM_EMOJI_REGEX);
    if (customEmoji)
      return `https://cdn.discordapp.com/emojis/${customEmoji.groups.id}`;
    const defaultEmoji = (0, import_twemoji_parser.parse)(emoji)[0];
    if (defaultEmoji)
      return defaultEmoji.url;
  }
  function getMessageUrl(guildId, channelId, messageId) {
    return `https://discord.com/channels/${guildId ?? "@me"}/${channelId}/${messageId}`;
  }
  function getSnowflakeTimestamp(snowflake) {
    return (0, import_dayjs2.default)(Number(DiscordSnowflake.deconstruct(snowflake).timestamp));
  }
  ...
  async function extractMessages({
    ...
    const channelNames = await root.file("messages/index.json").then((res) => res.json()).then((res) => new Map(Object.entries(res)));
    const guildNames = /* @__PURE__ */ new Map();
    for await (const channelDir of await root.dir("messages")) {
      if (channelDir.isDirectory) {
        ...
        if (channel.guild)
          guildNames.set(channel.guild.id, channel.guild.name);
        const messages = await channelDir.file("messages.csv").then((file) => file.csv({ withHeaders: true }));
        for await (const message of messages) {
          ...
          if (channel.type === ChannelTypes.DM || channel.type === ChannelTypes.GROUP_DM)
            ...
            channelMessageCounter.incr(channel.id);
          if (channel.guild)
            guildMessageCounter.incr(channel.guild.id);
          const date = (0, import_dayjs3.default)(message.Timestamp);
          ...
          if (!newestDate || date.isAfter(newestDate))
            newestDate = date;
    ...
    for (const [hour, count] of hourlyCounter) {
      hourlyLabels.push((0, import_dayjs3.default)().hour(hour).format("h A"));
      hourlyData.push(count);
    }
    let monthlyLabels = [];
    for (let currentDate = oldestMessage.date.clone(); currentDate.isBefore(newestDate); currentDate = currentDate.add(1, "month"))
      monthlyLabels.push(currentDate.format("YYYY-MM"));
    return {
      Messages: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Messages"), /* @__PURE__ */ __jsx("div", null, "You've sent ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMessages)), " total messages in your", " ", /* @__PURE__ */ __jsx("b", null, formatNum(totalDays)), " days here."), /* @__PURE__ */ __jsx("div", null, "That's an average of ", /* @__PURE__ */ __jsx("b", null, formatNum(averageDailyMessages)), " messages a day."), /* @__PURE__ */ __jsx("div", null, "That's a total of ", /* @__PURE__ */ __jsx("b", null, formatNum(totalWords)), " words."), /* @__PURE__ */ __jsx("div", null, "That's a total of ", /* @__PURE__ */ __jsx("b", null, formatNum(totalCharacters)), " characters."), /* @__PURE__ */ __jsx("div", null, "Text wasn't enough? You sent ", /* @__PURE__ */ __jsx("b", null, formatNum(totalAttachments)), " files."), /* @__PURE__ */ __jsx("div", null, "Like emojis? You used ", /* @__PURE__ */ __jsx("b", null, formatNum(totalCustomEmojis)), " custom emojis and", " ", /* @__PURE__ */ __jsx("b", null, formatNum(totalDefaultEmojis)), " default emojis."), /* @__PURE__ */ __jsx("div", null, "Overall, you pinged ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMentions)), " users, roles, and channels"), /* @__PURE__ */ __jsx("div", null, "Whoops, you edited ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMessagesEdited)), " messages and deleted", " ", /* @__PURE__ */ __jsx("b", null, formatNum(totalMessagesDeleted)), " messages."), /* @__PURE__ */ __jsx("div", null, "You added ", /* @__PURE__ */ __jsx("b", null, formatNum(totalReactions)), " reactions to messages."), /* @__PURE__ */ __jsx("div", null, "Your first message was", " ", /* @__PURE__ */ __jsx("b", null, /* @__PURE__ */ __jsx("a", {
        href: getMessageUrl(oldestMessage.guild_id, oldestMessage.channel_id, oldestMessage.message.ID)
      }, oldestMessage.message.Contents)), " ", "on ", /* @__PURE__ */ __jsx("b", null, oldestMessage.date.format(SHORT_DATE_TIME)), " in", " ", /* @__PURE__ */ __jsx("b", null, channelNames.get(oldestMessage.channel_id) ?? "Unknown"))),
      TopWords: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topWords.length, " words"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topWords.map(([word, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", word), /* @__PURE__ */ __jsx("td", {
        className: "end"
      }, formatNum(count))))))),
      TopEmojis: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topEmojis.length, " emojis"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topEmojis.map(([emoji, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", /* @__PURE__ */ __jsx("img", {
        className: "emoji",
        src: getEmojiUrl(emoji)
      })), /* @__PURE__ */ __jsx("td", {
        className: "end"
      }, formatNum(count))))))),
      TopDms: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topDms.length, " DMs"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topDms.map(([dmId, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", channelNames.get(dmId)), /* @__PURE__ */ __jsx("td", {
        className: "end"
      }, formatNum(count))))))),
      TopChannels: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topChannels.length, " Channels"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topChannels.map(([channelId, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", channelNames.get(channelId)), /* @__PURE__ */ __jsx("td", {
        className: "end"
      }, formatNum(count))))))),
      TopGuilds: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Top ", topGuilds.length, " Guilds"), /* @__PURE__ */ __jsx("table", null, /* @__PURE__ */ __jsx("tbody", null, topGuilds.map(([guildId, count], index2) => /* @__PURE__ */ __jsx("tr", null, /* @__PURE__ */ __jsx("td", null, index2 + 1, ". ", guildNames.get(guildId)), /* @__PURE__ */ __jsx("td", {
        className: "end"
      }, formatNum(count))))))),
      MessagesPerMonth: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx(Chart2, {
        type: "bar",
      ...
      MessagesPerHour: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx(Chart2, {
        type: "bar",
  ...
  // src/services/discord/tiles/Account.jsx
  ...
  async function extractAccount({ root }) {
    ...
    const moneySpent = formatCurrency(user.payments.reduce((total, { amount, amount_refunded }) => total + amount - amount_refunded, 0) / 100, user.payments[0]?.currency);
    const topGames = user.user_activity_application_statistics.sort((a, b) => b.total_duration - a.total_duration).slice(0, 10);
    if (__ENV !== "dev")
      for (const game of topGames)
        game.application_name = await fetch(`https://discord.com/api/v10/applications/${game.application_id}/rpc`).then((res) => res.json()).then((res) => res.name).catch(() => {
        });
    return {
      Account: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, /* @__PURE__ */ __jsx("img", {
        className: "account-avatar",
        src: avatarUrl,
        alt: "Avatar"
      }), user.username, /* @__PURE__ */ __jsx("span", {
        className: "account-discriminator"
      }, formatDiscriminator(user.discriminator))), /* @__PURE__ */ __jsx("div", {
        className: "field-group"
      }, /* @__PURE__ */ __jsx(Field, {
        label: "id",
        value: user.id
      }), /* @__PURE__ */ __jsx(Field, {
        label: "email",
        ...
        label: "created",
        value: created.format(SHORT_DATE_TIME)
      }), /* @__PURE__ */ __jsx(Field, {
        label: "ip address",
        value: user.ip
      }), /* @__PURE__ */ __jsx(Field, {
        label: "friends",
        value: formatNum(user.relationships.length)
      }), /* @__PURE__ */ __jsx(Field, {
        label: "money spent",
        value: moneySpent
      }))),
      Flags: () => /* @__PURE__ */ __jsx(Tile, {
        size: 2
      }, /* @__PURE__ */ __jsx("h1", null, "Flags"), /* @__PURE__ */ __jsx("div", {
        className: "field-group"
      }, extractUserFlags(user.flags).map(({ flag, description }) => /* @__PURE__ */ __jsx(Field, {
        label: flag,
        value: description
      })))),
      Connections: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Connections"), /* @__PURE__ */ __jsx("div", {
        className: "field-group"
      }, user.connections.map(({ type, name }) => /* @__PURE__ */ __jsx(Field, {
        label: type,
        value: name
      })))),
      TopGames: () => /* @__PURE__ */ __jsx(Tile, {
        size: 2
      }, /* @__PURE__ */ __jsx(Chart2, {
        type: "bar",
        ...
        options: {
          scales: {
            y: { ticks: { callback: (label) => import_dayjs4.default.duration(label, "seconds").humanize() } }
          }
        }
      }))
    };
  ...
  // src/services/discord/tiles/Activity.jsx
  var import_dayjs5 = __toESM(require_dayjs_min());
  async function extractActivity({ root }) {
    const analyticsDir = await root.dir("activity/analytics");
    const createdAt = await root.file("account/user.json").then((file) => file.json()).then((user) => getSnowflakeTimestamp(user.id));
    let events = {
      activity_updated: 0,
      captcha_served: 0,
      captcha_solved: 0,
      ...
      for await (const chunk of chunks)
        chunk.split("\n").forEach((line) => {
          try {
            ...
            if (events.hasOwnProperty(event.event_type))
    ...
    const totalDays = (0, import_dayjs5.default)().diff(createdAt, "days");
    ...
    return {
      ...
      Analytics: () => /* @__PURE__ */ __jsx(Tile, null, /* @__PURE__ */ __jsx("h1", null, "Analytics"), /* @__PURE__ */ __jsx("div", null, "Your status was updated ", /* @__PURE__ */ __jsx("b", null, formatNum(events.activity_updated)), " times."), /* @__PURE__ */ __jsx("div", null, "Are you a robot? You were served ", /* @__PURE__ */ __jsx("b", null, formatNum(events.captcha_served)), " captchas and solved ", /* @__PURE__ */ __jsx("b", null, formatNum(events.captcha_solved)), " of them."), /* @__PURE__ */ __jsx("div", null, "Overall, you viewed ", /* @__PURE__ */ __jsx("b", null, formatNum(events.guild_viewed)), " servers and opened", " ", /* @__PURE__ */ __jsx("b", null, formatNum(events.channel_opened)), " channels."), /* @__PURE__ */ __jsx("div", null, "That's an average of ", /* @__PURE__ */ __jsx("b", null, formatNum(averageDailyGuilds)), " guilds and", " ", /* @__PURE__ */ __jsx("b", null, formatNum(averageDailyChannels)), " channels a day."), /* @__PURE__ */ __jsx("div", null, "Ring ring, you joined ", /* @__PURE__ */ __jsx("b", null, formatNum(events.join_call + events.join_voice_channel)), " ", "calls and voice channels."), /* @__PURE__ */ __jsx("div", null, "Fast typer? You used ", /* @__PURE__ */ __jsx("b", null, formatNum(events.keyboard_shortcut_used)), " keyboard shortcuts."), /* @__PURE__ */ __jsx("div", null, "Discord detected ", /* @__PURE__ */ __jsx("b", null, formatNum(events.launch_game)), " game launches."), /* @__PURE__ */ __jsx("div", null, "In total, you edited ", /* @__PURE__ */ __jsx("b", null, formatNum(events.message_edited)), " messages and deleted", " ", /* @__PURE__ */ __jsx("b", null, formatNum(events.message_deleted)), " of them."), /* @__PURE__ */ __jsx("div", null, "You opened the quick switcher ", /* @__PURE__ */ __jsx("b", null, formatNum(events.quickswitcher_opened)), " times."))
    };
  }
  ...
  // src/services/discord/index.jsx
  async function extractDiscord({ root }) {
    const { Account, Flags, Connections, TopGames } = await extractAccount({ root });
    const { totalReactions, totalMessagesEdited, totalMessagesDeleted, Analytics } = await extractActivity({ root });
    const {
      Messages,
      TopWords,
      TopEmojis,
    ...
    return () => /* @__PURE__ */ __jsx(__fragment, null, /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Account, null), /* @__PURE__ */ __jsx(Flags, null), /* @__PURE__ */ __jsx(Connections, null)), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(Analytics, null), /* @__PURE__ */ __jsx(Messages, null)), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(TopWords, null), /* @__PURE__ */ __jsx(TopGames, null), /* @__PURE__ */ __jsx(TopEmojis, null)), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(TopDms, null), /* @__PURE__ */ __jsx(TopChannels, null), /* @__PURE__ */ __jsx(TopGuilds, null)), /* @__PURE__ */ __jsx(Row, null, /* @__PURE__ */ __jsx(MessagesPerMonth, null), /* @__PURE__ */ __jsx(MessagesPerHour, null)));
  }

  // src/index.jsx
  window.__ENV = new URL(location).searchParams.get("env");
  var drag = document.getElementById("drag");
  drag.addEventListener("dragover", async (e) => {
    e.preventDefault();
  ...
  drag.addEventListener("drop", async (e) => {
    ...
    console.timeEnd();
    document.body.appendChild(/* @__PURE__ */ __jsx("div", {
      className: "container"
    }, /* @__PURE__ */ __jsx(Discord, null)));
    drag.remove();
  }, false);
})();
/*!
